...
#define Linux_NetworkIPv4ParameterSetInstance Linux_NetworkIPv4ParameterModifyInstance
#endif

static char * _FILEROOT = "/proc/sys/net/ipv4";
static const char * _CLASSNAME = "Linux_NetworkIPv4Parameter";
 ...
 * Cleanup
 */
CMPIStatus Linux_NetworkIPv4ParameterCleanup(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_NetworkIPv4ParameterEnumInstanceNames(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_NetworkIPv4ParameterEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * GetInstance
 */
CMPIStatus Linux_NetworkIPv4ParameterGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * CreateInstance
 */
CMPIStatus Linux_NetworkIPv4ParameterCreateInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
 ...
 * SetInstance
 */
CMPIStatus Linux_NetworkIPv4ParameterSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_NetworkIPv4ParameterDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_NetworkIPv4ParameterExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
...
CMInstanceMIStub( Linux_NetworkIPv4Parameter,
