...
#define Linux_FileSystemParameterSetInstance Linux_FileSystemParameterModifyInstance
#endif

static char * _FILEROOT = "/proc/sys/fs";
static const char * _CLASSNAME = "Linux_FileSystemParameter";
 ...
 * Cleanup
 */
CMPIStatus Linux_FileSystemParameterCleanup(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_FileSystemParameterEnumInstanceNames(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_FileSystemParameterEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * GetInstance
 */
CMPIStatus Linux_FileSystemParameterGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * CreateInstance
 */
CMPIStatus Linux_FileSystemParameterCreateInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
 ...
 * SetInstance
 */
CMPIStatus Linux_FileSystemParameterSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_FileSystemParameterDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_FileSystemParameterExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
...
CMInstanceMIStub( Linux_FileSystemParameter,
