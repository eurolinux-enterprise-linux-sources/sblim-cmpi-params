...
#define Linux_KernelParameterSetInstance Linux_KernelParameterModifyInstance
#endif

static char * _FILEROOT = "/proc/sys/kernel";
static const char * _CLASSNAME = "Linux_KernelParameter";
 ...
 * Cleanup
 */
CMPIStatus Linux_KernelParameterCleanup(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_KernelParameterEnumInstanceNames(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_KernelParameterEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * GetInstance
 */
CMPIStatus Linux_KernelParameterGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * CreateInstance
 */
CMPIStatus Linux_KernelParameterCreateInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
 ...
 * SetInstance
 */
CMPIStatus Linux_KernelParameterSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_KernelParameterDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_KernelParameterExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
...
CMInstanceMIStub( Linux_KernelParameter,
