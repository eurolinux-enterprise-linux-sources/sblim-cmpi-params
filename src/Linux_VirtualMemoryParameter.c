...
#define Linux_VirtualMemoryParameterSetInstance Linux_VirtualMemoryParameterModifyInstance
#endif

static char * _FILEROOT = "/proc/sys/vm";
static const char * _CLASSNAME = "Linux_VirtualMemoryParameter";
 ...
 * Cleanup
 */
CMPIStatus Linux_VirtualMemoryParameterCleanup(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_VirtualMemoryParameterEnumInstanceNames(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_VirtualMemoryParameterEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * GetInstance
 */
CMPIStatus Linux_VirtualMemoryParameterGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
 ...
 * CreateInstance
 */
CMPIStatus Linux_VirtualMemoryParameterCreateInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
 ...
 * SetInstance
 */
CMPIStatus Linux_VirtualMemoryParameterSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_VirtualMemoryParameterDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_VirtualMemoryParameterExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * ref, 
...
CMInstanceMIStub( Linux_VirtualMemoryParameter,
